...
class Orders extends CI_Controller {
    ...
    */
    ...
    {
        $_cliente_info = $this->orders_model->get_by_id($id);
    ...
    */
     ...
     public function load_list()
    {
        ...
        $this->data['items'] = $this->orders_model->get();
    ...
    */
    public function action_add()
    {
        ...
        $_result = $this->orders_model->add($_data);
    ...
    */
    public function action_update()
    {
        ...
        $_result = $this->orders_model->update($_data,$_cliente_id);
    ...
    public function validate_post($_id=FALSE)
    {
         ...
         if ($_id) {
            ...
            $_cliente_info = $this->orders_model->get_by_id($_id);
        ...
        $_cliente_info = $this->orders_model->get_by_dni($_dni);
    ...
    */
    public function action_delete($id)
    {
        ...
        $_result = $this->orders_model->update($_data, $_cliente_info->id);
 ...
 public function load_modal()
 {
    ...
    $this->data['items_products'] = $this->products_model->get();
      $_html = $this->load->view($this->controller.'/load_modal',$this->data,TRUE);
      exit(json_encode(['status'=>TRUE,'html'=>$_html]));
