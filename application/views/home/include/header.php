            ...
            <nav class="navigation">
              <ul class="list-unstyled">
                  <li><a href="index-2.html"><i class="fa fa-bookmark-o"></i><span class="nav-label">Dashboard</span></a></li>
                    ...
                    <li class="has-submenu"><a href="#"><i class="fa fa-file-text-o"></i> <span class="nav-label">MANTENIMIENTOS</span></a>
                      <ul class="list-unstyled">
                        ...
                        <li class="has-submenu"><a href="#"><i class="fa fa-file-text-o"></i> <span class="nav-label">ORDENES</span></a>
                      <ul class="list-unstyled">
                          <li><a href="<?=base_url('orders/load_list')?>">Factura</a></li>
